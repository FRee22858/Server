...
//比较时间
int TimeUtil::CompareTime(string srcTime, string desTime)
{
	long srcSecond = StrToSecondTime(srcTime);
	long desSecond = StrToSecondTime(desTime);

	return (srcSecond - desSecond);
}