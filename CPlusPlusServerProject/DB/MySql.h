...
#include <vector>
	...
	#include<Windows.h>
	#include "../DB/thirdlib/mysql/x64/include/mysql.h"
    #pragma comment(lib, "../DB/thirdlib/mysql/x64/libmysql.lib")
    #pragma warning(disable : 4244 4996)
#elif  defined(_WIN32) || defined(__WIN32__)
	#include "../DB/thirdlib/mysql/win32/mysql.h"
	#pragma comment(lib, "../DB/thirdlib/mysql/win32/libmysql.lib")
	#pragma warning(disable : 4244 4996)
#else
    #include "unistd.h"
    #include "../DB/thirdlib/mysql/linux/mysql.h"
#endif
